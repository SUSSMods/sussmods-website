...
export default function SaveBtn(props) {
  ...
  const [btnType, setBtnType] = useState(
    savedMods.includes(props.modCode) ? removeBtn : saveBtn
  );
  ...
  const toggleIsSaved = () => {
    ...
    setBtnType((prevBtnType) => {
      const newBtnType =
        prevBtnType.btnText.toLowerCase() === "save" ? removeBtn : saveBtn;
      return newBtnType;
    });
  ...
  return (
    <>
      <button className={btnType.btnClass} onClick={toggleIsSaved}>
        {btnType.btnIcon}
